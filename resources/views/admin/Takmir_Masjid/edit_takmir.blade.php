                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <!-- Date -->
                            <div class="col-6">
                                <form action="{{route('takmir.update', $edit->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama')
                                            is-invalid
                                        @enderror" id="nama"  value="{{$edit->nama}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nomor')
                                            is-invalid
                                        @enderror" id="nomor"  value="{{$edit->nomor}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('alamat')
                                            is-invalid
                                        @enderror" id="alamat"  value="{{$edit->alamat}}"
