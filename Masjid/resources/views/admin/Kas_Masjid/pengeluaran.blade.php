...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <button type="button" class="btn btn-primary" id="tambah_data_pengeluaran">
    ...
    {{-- modal --}}
    <div class="modal fade" id="modal-pengeluaran-add">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Pengeluaran Kas Masjid</h5>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="add_pengeluaran" name="pengeluaran"
    ...
    <div class="modal fade" id="modal-pengeluaran-edit">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Pengeluaran Kas Masjid</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="#">
                        ...
                        <div>
                            <input type="hidden" id="edit_pg_id">
                        </div>
                        <div class="form-group">
                            <label for="keterangan">Keterangan</label>
                        ...
                        <div class="form-group">
                            <label for="pemasukan">Jumlah Pengeluaran</label>
                            <input type="text" class="form-control " id="pengeluaran_edit" placeholder="pengeluaran">
                        </div>
                        <!-- Date -->
                        <div class="form-group">
                            <label>Date:</label>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-primary" id="edit_pengeluaran">Edit</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
@section('script')
    {{-- Semua Function AJax --}}
    <script src="{{asset('js/Kas_Masjid/Data_Pengeluaran/allFunctionAjax.js')}}"></script>
    {{-- sweet ALert Github --}}
    ...
    <script src="{{ asset('js/Kas_Masjid/Data_Pengeluaran/buttons.html5.js') }}"></script>
    <script src="{{ asset('js/Kas_Masjid/Data_Pengeluaran/buttons.print.js') }}"></script>
